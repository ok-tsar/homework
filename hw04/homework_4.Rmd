...
The test missclassifcation rate (0.393939) is pretty high compared to the validation misclassification rate. But this is expected. It is also interesting that the simplest model does the best job. This also makes sence as random forest models work better with many weak learners!
